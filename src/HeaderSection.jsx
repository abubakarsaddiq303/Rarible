...
export default function HeaderSection() {
    return (
        ...
        <div className="row container-fluid mt-2 ">
            ...
            <MDBCardImage src='https://mdbcdn.b-cdn.net/wp-content/uploads/2020/06/vertical.jpg'  alt='...' fluid  className='col-md-3 col-sm-5  FirstCol mywidth  m-2 '/>
            </div>
            <div className="col-md-8 col-sm-5  SecondCol ml-2 ">
                <div className="row">
